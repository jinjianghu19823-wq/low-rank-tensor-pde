...
% applied to every term without recompression. The paper_order variant
% applies adaptive RoundSum before forming each residual sketch column and
% uses batch local projection coefficients. The earlier
% exact_sketch_before_roundsum variant remains available for reproducing
% historical dissertation experiments.
%
...
if ~isfield(settings, 'algorithm_variant')
    settings.algorithm_variant = "exact_sketch_before_roundsum";
end
